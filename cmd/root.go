...
import (
	...
	dbInfra "github.com/franthescomarchesi/ports_and_adapters/adapters/db"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.ports_and_adapters.yaml)")
